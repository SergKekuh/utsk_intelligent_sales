-- ============================================================================
-- UTSK Intelligent Sales — Миграция 33: Обновление лимитов и очистка причин ML-рекомендаций
-- ============================================================================

-- 1. Функция 1: Сопутствующие товары (Cross-sell) с увеличенным пулом кандидатов
...
-- 2. Функция 2: Похожие типоразмеры с увеличенным пулом кандидатов
...
-- 3. Функция 3: Популярные товары в сегменте (направление деятельности)
